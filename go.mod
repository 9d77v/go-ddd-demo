module github.com/9d77v/go-ddd-demo

go 1.19

require (
	github.com/99designs/gqlgen v0.17.14
	github.com/9d77v/go-pkg v0.1.5
	github.com/alibaba/ioc-golang v1.0.1-0.20220813151154-8b5d5bcd46ff
...
require (
	...
	go.opentelemetry.io/collector v0.58.0 // indirect
